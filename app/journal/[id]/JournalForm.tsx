...
interface JournalFormProps {
    journalName: string;
    setShowJournalForm: (_: boolean) => void;
    setShowJournalDeleteConfirm: (_: boolean) => void;
    updateJournalName: (journalName: string) => void;
}

const JournalForm = (
    { journalName, setShowJournalForm, setShowJournalDeleteConfirm, 
        updateJournalName }: JournalFormProps) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            ...
            <div className="bg-[#fdfdfd] w-[80%] md:w-[32rem] shadow-2xl border border-gray rounded-md p-6 z-10 flex flex-col">
                ...
                <input 
                    ...
                    onInput={(e) => setJournalTitle((e.target as HTMLInputElement).value)}
                    value={journalTitle || ""}
                />
