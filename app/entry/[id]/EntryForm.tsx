...
import { entry } from '@/app/types/common-types';

interface EntryFormProps {
    entryIn: entry;
    updateEntry: (data: entry) => void;
    setShowEntryForm: (_: boolean) => void;
    setShowEntryDeleteConfirm: (_: boolean) => void;
}

const EntryForm = (
    { entryIn, updateEntry, setShowEntryForm, setShowEntryDeleteConfirm }: EntryFormProps
) => {
